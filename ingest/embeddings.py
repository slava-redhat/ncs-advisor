"""Local embeddings via host Ollama (GPU). nomic-embed-text, 768-dim.

Task prefixes matter: search_document at ingest, search_query at retrieve.
Keep in sync with ui/advisor/embeddings.py.
"""
import os
import requests
